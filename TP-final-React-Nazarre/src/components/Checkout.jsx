                ...
                <div className="col-md-3">
                    <form>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="nombre" onInput={(e) => {setEmail(e.target.value)}} />                        
                        </div>
                        <div className="mb-3">
                            <label htmlFor="telefono" className="form-label">telefono</label>
                            <input type="text" className="form-control" id="nombre" onInput={(e) => {setTelefono(e.target.value)}} />                        
                        </div>
