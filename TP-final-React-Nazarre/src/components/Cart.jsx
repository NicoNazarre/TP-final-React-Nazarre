                        ...
                        </tr>
                        {
                            cart.map(item => (
                                <tr key={item.index}>
                                    ...
                                    <td className="text-end align-middle" width="20%"><button className="btn btn-warning" onClick={() => {removeItem(item.index)}} title={"Eliminar Producto"}><img src={trash} alt={"Eliminar Producto"} width={32} /></button></td>
                                </tr>
                            ))
                        }
                    <tr>
